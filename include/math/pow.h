...
struct PowOp {
    ...
    static SIMD_T apply_simd(const SIMD_T &base, const SIMD_T &exp);
};
...
template<>
template<>
inline __m128i PowOp<int>::apply_simd<__m128i>(const __m128i &base, const __m128i &exp) {
#if defined(USE_SVML)
...
template<>
template<>
inline __m256i PowOp<int>::apply_simd<__m256i>(const __m256i &base, const __m256i &exp) {
#if defined(USE_SVML)
...
template<>
template<>
inline __m512i PowOp<int>::apply_simd<__m512i>(const __m512i &base, const __m512i &exp) {
#if defined(USE_SVML)
