...
inline void add_arrays_int32(int32_t *result, const int32_t *a, const int32_t *b, size_t n);

template<typename T>
void add_arrays(T *result, const T *a, const T *b, size_t n) {
...
template<>
inline void add_arrays<float>(float *result, const float *a, const float *b, size_t n) {
    size_t i = 0;
#if defined(__AVX512F__)
    for (; i + 15 < n; i += 16) {
...
template<>
inline void add_arrays<double>(double *result, const double *a, const double *b, size_t n) {
    size_t i = 0;
#if defined(__AVX512F__)
    for (; i + 7 < n; i += 8) {
